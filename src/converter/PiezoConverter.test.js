...
describe('PiezoConverter', () => {
  describe('#convert', () => {
    it ('converts song', () => {
      ...
      expect(timeEncoder.encode.mock.calls[2][0]).toStrictEqual([7, 9])
      expect(timeEncoder.encode.mock.calls[3][0]).toStrictEqual([9])
      expect(timeEncoder.encode.mock.calls[4][0]).toStrictEqual([9])
